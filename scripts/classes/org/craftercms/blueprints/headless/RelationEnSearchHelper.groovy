...
class RelationEnSearchHelper{
    static final String NEWS_CONTENT_TYPE ="content-type:\"/page/eninvestorrelations\" "
    ...
    RelationEnSearchHelper(elasticsearch, UrlTransformationService urlTransformationService) {
